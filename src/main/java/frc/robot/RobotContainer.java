...
// The robot's subsystems
    public final ArmAndClaw m_armAndClaw = new ArmAndClaw();
...
private final Joystick joystick1 = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData(m_armAndClaw);
    ...
    SmartDashboard.putData("ClawCubeClose", new ClawCubeClose());
    SmartDashboard.putData("ClawConeClose", new ClawConeClose());
    SmartDashboard.putData("MoveToTarget", new MoveToTarget());
    SmartDashboard.putData("PlaceGamePiece", new PlaceGamePiece());
